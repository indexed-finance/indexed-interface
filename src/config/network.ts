export const NETWORKS = {
  ...
  rinkeby: {
    ...
    name: "rinkeby",
    addresses: {
      // * Matic vs. Eth (Weth vs. WMatic)
      // * CoinGecko calls use the API for CoinGecko for contract address, you have to select network.
      // instead of ethereum use polygon-pos
      //       // Uniswap & Sushiswap
      // CHANGING
